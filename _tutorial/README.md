...
[guide]: https://github.com/euskadi31/wire/blob/master/docs/guide.md
...
```shell
go install github.com/euskadi31/wire/cmd/wire@latest
```
...
$GOPATH/src/github.com/euskadi31/wire/_tutorial/wire.go:24:1:
inject InitializeEvent: no provider found for github.com/euskadi31/wire/_tutorial.Greeter
(required by provider of github.com/euskadi31/wire/_tutorial.Event)
...
[advanced]: https://github.com/euskadi31/wire/blob/master/docs/guide.md#advanced-features
[cleanup]: https://github.com/euskadi31/wire/blob/master/docs/guide.md#cleanup-functions
[interfaces]: https://github.com/euskadi31/wire/blob/master/docs/guide.md#binding-interfaces
[sets]: https://github.com/euskadi31/wire/blob/master/docs/guide.md#defining-providers
[values]: https://github.com/euskadi31/wire/blob/master/docs/guide.md#binding-values
